    ...
    if (window.location.hostname.endsWith('.dev.nav.no')) {
        return (
            <Alert variant="warning" size="medium" className="advarsel-banner-testversjon">
                ...
                <BodyLong>Informasjonen du finner her er ikke ekte.</BodyLong>
                <BodyLong>
                    Her kan du bli bedre kjent med Min side – Arbeidsgiver. Testversjonen kan avvike
                    noe fra den virkelige nettsiden.
                </BodyLong>
            </Alert>
        );
    }
