    ...
    (
        ...
        return (
            ...
            >
                ...
                <div className="ekspanderbartpanel__button-chevron">{apen ? <CollapseIcon title="Kollapsikon" aria-hidden="true"/> : <ExpandIcon title="Ekspanderikon" aria-hidden="true"/>}</div>
            </button>
        );
    }
