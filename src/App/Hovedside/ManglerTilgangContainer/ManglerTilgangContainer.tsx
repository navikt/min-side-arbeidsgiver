...
export const ManglerTilgangContainer:FunctionComponent = ()=> {
    return(<div>
        ...
        <span className={"mangler-tilgang-container"}>
            <ManglerTilgangLenkePanel tittel="Se tjenester som privatperson" infoTekst="Gå til Ditt NAV" lenke={lenkeTilDittNavPerson} />
            <ManglerTilgangLenkePanel tittel="Hvordan får jeg tilgang?" infoTekst="Lær om roller og tilganger i Altinn" lenke={lenkeTilTilgangsstyringsInfo} />
        </span>
    </div>
    )};
