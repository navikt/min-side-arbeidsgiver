...
export const HovedenhetCheckbox = (
    (
        {hovedenhet, erÅpen, toggleÅpen, children}: HovedenhetCheckboxProp,
    ) => {
                ...
                </div>
                {
                    visFlere ? <Button
                        ...
                        >
                            ...
                            >{erÅpen ? <Collapse aria-hidden={true}/> :
                                <Expand aria-hidden={true}/>} {erÅpen ? "skjul" : "vis"} underenheter</BodyShort>
                        </Button>
                        : null
                }
            </div>
