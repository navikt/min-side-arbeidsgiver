...
export const FeilmeldingContainer:FunctionComponent<Props> = (props)=>{
    return (<>
        ...
        {!props.visFeilmelding && props.visSyfoFeilmelding && (
            <AlertStripe type={"feil"} className={"FeilStripe"}>Vi har problemer med å hente informasjon om eventuelle sykemeldte du skal følge opp. Vi jobber med å løse saken så raskt som mulig</AlertStripe>
        )}
    </>)
};