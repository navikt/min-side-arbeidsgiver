...
const isToday = (date: Date): boolean => formatterDato(date) === formatterDato(today);

const isYesterday = (date: Date): boolean => formatterDato(date) === formatterDato(yesterday);

const isTomorrow = (date: Date): boolean => formatterDato(date) === formatterDato(tomorrow);
